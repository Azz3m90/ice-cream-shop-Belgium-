                        ...
                        <form id="booking-form" class="booking-form" method="post" data-validate>
                            <div class="utility-box-content">
                                ...
                                <div class="form-group" id="first_choice_out">
                                    ...
                                    <select id="first_choice" name="first_choice" class="form-control" required>
                                        ...
                                        <optgroup label="Classic Flavors">
                                            ...
                                            <option value="Better than Kinder Bueno">Better than Kinder Bueno</option>
                                            <option value="Better than Rocher">Better than Rocher</option>
                                            <option value="Better than snickers">Better than snickers</option>
                                            <option value="Better than Nutella">Better than Nutella</option>
                                            <option value="Pistachio">Pistachio</option>
                                            <option value="Coffee">Coffee</option>
                                            <option value="Fior di latte">Fior di latte</option>
                                            <option value="Salted Butter Caramel">Salted Butter Caramel</option>
                                            <option value="Speculoos">Speculoos</option>
                                            <option value="English Soup">English Soup</option>
                                            <option value="Tiramisù">Tiramisù</option>
                                            <option value="Coconut">Coconut</option>
                                        </optgroup>
                                        <optgroup label="Sorbet">
                                            <option value="Strawberry sorbet">Strawberry sorbet</option>
                                            <option value="Raspberry sorbet">Raspberry sorbet</option>
                                            <option value="Banana sorbet">Banana sorbet</option>
                                            <option value="Raspberry sorbet">Raspberry sorbet</option>
                                            <option value="Lychee sorbet">Lychee sorbet</option>
                                            <option value="Mango sorbet">Mango sorbet</option>
                                            <option value="Passion sorbet">Passion sorbet</option>
                                            <option value="Lime sorbet">Lime sorbet</option>
                                            <option value="Yellow lemon sorbet">Yellow lemon sorbet</option>
                                            <option value="Cantaloupe sorbet">Cantaloupe sorbet</option>
                                            <option value="Watermelon sorbet">Watermelon sorbet</option>
                                        </optgroup>
                                    </select>
                                ...
                                <div class="form-group" id="alternate_choice_out">
                                    ...
                                    <div class="form-helper-text">This choice will be used if either of the first
                                        two
