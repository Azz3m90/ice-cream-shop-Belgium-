                             ...
                             <div class="content dark">
                                 <div id="section-main-1-carousel-content">
                                     ...
                                     <div class="content-inner">
                                         ...
                                         <h5 class="text-muted mb-5">Verwen uzelf met onze klassieke smaken van romige
                                             vanille, rijke chocolade en verfrissende aardbei.</h5>
                                     </div>
                                     <div class="content-inner">
                                         <h1>Onweerstaanbaar</h1>
                                         <h5 class="text-muted mb-5">Voldoe aan uw zoete trek met onze heerlijke
                                             ijscreaties!</h5>
                                     </div>
                                 </div>
                     ...
                     <div class="container">
                         <div class="col-lg-5 col-md-9">
                             ...
                             <p class="lead text-muted mb-5 text-justify">Onze vestiging, geopend in 2021 na jaren van
                                 ...
                                 toewijding aan natuurlijke producten stelt ons in staat om efficiënt te voldoen aan de
                                 behoeften van onze professionele klanten door hen op maat gemaakte smaken aan te
                                 bieden. Voor particulieren bieden we een proefruimte met een prachtig terras, waar ze
                                 kunnen genieten van onze producten. Bovendien hebben ze de mogelijkheid om onze ijsjes
                                 per liter en taarten te kopen, afhankelijk van de beschikbaarheid, zonder voorafgaande
                                 reservering.</p>
                         </div>
                     </div>
             </div>
