   ...
   <div class="container">
    <div class="row align-items-center">
     <div class="col-lg-4 offset-lg-1 col-md-6 mb-5 mb-md-0">
      ...
      <span>
       <br>Address: Route de Philippeville 34 - 5651 Tarcienne </span>
      <span>
       <br>Cuisine: Seafood </span>
      <span>
       <br>Budget: - 25 EUR </span>
      <span>
       <br>Payment Method: All types of cards </span>
      <hr class="hr-md">
      <div class="row">
       <div class="col-sm-6 mb-3 mb-sm-0">
        <h6 class="mb-1 text-muted">Phone:</h6> <a href="tel:+071218620" target="_blank">071 21 86 20</a>
       </div>
       <div class="col-sm-6">
