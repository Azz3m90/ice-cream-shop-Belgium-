    ...
    <div class="menu-sample-carousel carousel inner-controls" data-slick='{
        ...
        <div class="menu-sample">
            <a href="./page-sur-place.php">
                <img src="./assets/img/surplace/surplace_4.jpeg" alt="sur-place" style="width: 500px;height:400px;">
        ...
        <div class="menu-sample">
            <a href="./page-reservation.php">
                <img src="./assets/img/icecream/cake.jpg" alt="gâteaux" style="width: 500px;height:400px;">
                <h3 class="title" title="Nos bûches et gâteaux"> Gâteaux</h3>
            </a>
        </div>
        <!-- Menu Sample -->
        <div class="menu-sample">
            <a href="./Professionnels.php">
                ...
                <h3 class="title" title="Professionnels"> Professionnels</h3>
            </a>
        </div>
        <!-- Menu Sample -->
        <div class="menu-sample">
            <a href="#" id="reservation">
                ...
                <h3 class="title" title="Réservations Traiteurs Évènements"> Réservations Traiteurs </h3>
            </a>
        </div>
    </div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <h4>
            ...
            veuillez nous contacter par téléphone au <a href="tel:+0497476548" style="font-weight:bold;" target="_blank">
