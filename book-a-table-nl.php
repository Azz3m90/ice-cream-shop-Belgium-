...
<div class="dropdown col-md-2 right mt-5">
 ...
 <ul class="dropdown-menu" aria-labelledby="Dropdown">
  ...
  <li>
   <a class="dropdown-item" href="book-a-table-en.php">
    <i class="flag flag-united-kingdom"></i>English </a>
  </li>
  <li>
   <a class="dropdown-item" href="book-a-table.php">
    ...
    <div class="col-lg-6">
     ...
     <div class="utility-box">
      <div class="utility-box-title bg-dark dark">
       <div class="bg-image">
        <img src="./assets/img/dropdown-about/dropdown-about-2.jpg" alt="">
       </div>
       <div>
      ...
      <form id="booking-form" class="booking-form" data-validate>
       <div class="utility-box-content">
        ...
        <div class="row">
         <div class="form-group">
          ...
          <p>Kan de afbeelding niet lezen? <a href='#' onclick='refreshCaptcha(event);'>Klik hier</a> om te vernieuwen
          </p>
       ...
       <button class="utility-box-btn btn btn-secondary btn-block btn-lg btn-submit" type="submit">
        <span class="description">Reserveer nu!</span>
        <span class="success">
