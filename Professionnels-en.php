        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 offset-lg-5">
                    ...
                    <h4 class="text-muted mb-0" style="text-align: justify;">We can cater to all your needs in fine
                        groceries, cocoa production,
                        Michelin-starred restaurants, etc.
                        Whether you're a French, Maghrebi, Asian, Italian gastronomic restaurant, we'll create your
                        signature ice cream according to your taste, tradition, and need.
                    ...
                    <div class="utility-box">
                        ...
                        <form id="booking-form" class="booking-form" method="post" data-validate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="delivery_date" name="delivery_date" class="form-control" placeholder="Preferred delivery date" min="<?php echo date('Y-m-d'); ?>" required>
                            </div>
                            <div class="form-group">
