...
<div id="content">
                            ...
                            <div class="utility-box-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-helper-text">Un minimum de 3 jours est requis pour toutes les
                                        demandes soumises.
                                        <br />Pour toute demande urgente, merci de nous appeler.
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="first_choice_out">
                                    ...
                                    <select id="first_choice" name="first_choice" class="form-control" required>
                                        ...
                                        <optgroup label="Classic Flavors">
                                            ...
                                            <option value="Mieux que Kinder Bueno">Mieux que Kinder Bueno</option>
                                            <option value="Mieux que Rocher">Mieux que Rocher</option>
                                            <option value="Mieux que snikers">Mieux que snikers</option>
                                            <option value="Mieux que Nutella">Mieux que Nutella</option>
                                            ...
                                            <option value="Spéculos">Spéculos</option>
                                            <option value="Zuppa inglese">Zuppa inglese</option>
                                            <option value="Tiramisù">Tiramisù</option>
                                            <option value="Coco">Coco</option>
                                        </optgroup>
                                        <optgroup label="Sorbet">
                                            <option value="Fraise sorbet">Fraise sorbet</option>
                                            <option value="Framboise sorbet">Framboise sorbet</option>
                                            <option value="Banane sorbet">Banane sorbet</option>
                                            <option value="Framboise sorbet">Framboise sorbet</option>
                                            <option value="Litchi sorbet">Litchi sorbet</option>
                                            <option value="Mangue sorbet">Mangue sorbet</option>
                                            <option value="Passion sorbet">Passion sorbet</option>
                                            <option value="Citron vert sorbet">Citron vert sorbet</option>
                                            <option value="Citron jaune sorbet">Citron jaune sorbet</option>
                                            <option value="Melon cavaillon sorbet">Melon cavaillon sorbet</option>
                                            <option value="Pastèque sorbet">Pastèque sorbet</option>
                                        </optgroup>
                                    </select>
    ...
    <footer id="footer" class="bg-dark dark">
        ...
        <div class="window" id="window">
            <div class="window-header">Prix </div>
            <div class="window-body">
                <strong>Couverture meringue à italienne:</strong><br>
                - 4,5 € par personne à partir de 8 personnes<br>
                - 5 € pour des gâteaux plus petits<br><br>
                <strong>Couverture chocolat croquant noisette:</strong><br>
                - 6 € par personne
            </div>
