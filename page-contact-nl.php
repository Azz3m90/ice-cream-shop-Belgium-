...
<div class="dropdown col-md-2 right mt-5">
 ...
 <ul class="dropdown-menu" aria-labelledby="Dropdown1">
  ...
  <li>
   <a class="dropdown-item" href="page-contact-en.php">
    <i class="flag flag-united-kingdom"></i>English </a>
  </li>
  <li>
   <a class="dropdown-item" href="page-contact.php">
    <i class="flag-france flag">Français</i>
   </a>
  </li>
 </ul>
</div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-lg-8 offset-lg-4">
     <h1 class="mb-0">Neem contact op</h1>
  ...
  <div class="container">
   <div class="row align-items-center">
    <div class="col-lg-4 offset-lg-1 col-md-6 mb-5 mb-md-0">
     <img src="assets/img/matthiasandsea.svg" alt="" class="mb-5" width="250">
     <h4 class="mb-0">
      <strong>MATTHIAS AND SEA</strong>
     </h4>
     <span>
      <br>Adres: Route de Philippeville 34 - 5651 Tarcienne </span>
     <span>
      <br>Keuken: Zeevruchten </span>
     <span>
      <br>Budget: - 25 EUR </span>
     <span>
      <br>Betaalmethode: Alle soorten kaarten </span>
     <hr class="hr-md">
     <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
       <h6 class="mb-1 text-muted">Telefoon:</h6> <a href="tel:+071218620" target="_blank">071 21 86 20</a>
      </div>
      <div class="col-sm-6">
       <h6 class="mb-1 text-muted">E-mail:</h6>
       <a href="#"><a href="mailto:info@matthiasandsea.be" target="_blank">info@matthiasandsea.be</a></a>
      </div>
     </div>
     <hr class="hr-md">
     <h6 class="mb-3 text-muted">Volg ons!</h6>
     ...
     <a href="#" class="icon icon-social icon-circle icon-sm icon-twitter" target="_blank">
      <i class="fa fa-twitter"></i>
     </a>
     <a href="#" class="icon icon-social icon-circle icon-sm icon-youtube" target="_blank">
      <i class="fa fa-youtube"></i>
     </a>
     <a href="#" class="icon icon-social icon-circle icon-sm icon-instagram" target="_blank">
      <i class="fa fa-instagram"></i>
     </a>
    </div>
    <div class="col-lg-5 offset-lg-2 col-md-6">
     <!--<div class="google-map h-500 shadow" data-lat="50.320699" data-lon="4.477533"></div>-->
     <div class="h-500 shadow">
      <iframe
       src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1273.7318474343963!2d4.476828171176896!3d50.32059971578564!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c220e1096581b5%3A0xe38087c80a9a342a!2sMatthias%20and%20Sea!5e0!3m2!1sen!2sus!4v1697026026524!5m2!1sen!2sus"
