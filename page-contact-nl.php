        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 offset-lg-1 col-md-6 mb-5 mb-md-0">
                    ...
                    <span>
                        <br>Adres: Route de Philippeville 34, Tarcienne, België
                    </span>
                    <span>
                        <br>Telefoon: +32 497 47 65 48
                    </span>
                    <span>
                        <br>Diensten: Buitenzitten, Afhalen aan de stoep
                    </span>
                    <span>
                        <br>Prijsklasse: $
                    </span>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <h6 class="mb-1 text-muted">Telefoon:</h6>
                            <a href="tel:+32497476548" target="_blank">
                                <i class="fa fa-phone fa-lg"></i> +32 497 47 65 48
                            </a>
                        </div>
                        <div class="col-sm-6">
