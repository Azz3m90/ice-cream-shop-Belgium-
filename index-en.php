     ...
     <div class="content dark">
       <div id="section-main-1-carousel-content">
         ...
         <div class="content-inner">
           ...
           <h5 class="text-muted mb-5">Indulge yourself with our classic flavors of creamy vanilla, rich chocolate, and refreshing strawberry.</h5>
         </div>
         <div class="content-inner">
           <h1>Irresistible</h1>
           <h5 class="text-muted mb-5">Satisfy your sweet cravings with our delightful ice cream creations!</h5>
         </div>
       </div>
...
<section class="section section-bg-edge">
 ...
 <div class="col-lg-5 col-md-9">
  ...
  <p class="lead text-muted mb-5 text-justify">Our establishment, opened in 2021 after years of preparation, specializes in the production and distribution of ice creams and sorbets. We serve a variety of clients, including ice cream parlors, restaurants, institutions, wholesalers, and delicatessens, with included delivery service. Our commitment to natural products enables us to efficiently meet the needs of our professional clients by offering them custom flavors. For individuals, we provide a tasting room with a beautiful terrace, where they can savor our products. Additionally, they have the opportunity to purchase our ice creams by the liter and cakes, subject to availability, without prior reservation.</p>
 </div>
</div>
 </div>
   ...
   <div class="footer-first-row row">
    ...
    <a href="tel:+0497476548" target="_blank">
       ...
       <tr>
        ...
        <td class="content"><a href="mailto:info@matthiasandsea.be" target="_blank"> <i class="fa fa-lg fa-envelope"></i>  info@matthiasandsea.be</a></td>
       </tr>
      </tbody>
     </table>
