...
<div class="dropdown col-md-2 right mt-5">
 ...
 <ul class="dropdown-menu" aria-labelledby="Dropdown">
  ...
  <li>
   <a class="dropdown-item" href="./dishes.php">
...
<nav id="panel-mobile">
 ...
 <div class="dropdown col-12">
  ...
  <ul class="dropdown-menu" aria-labelledby="Dropdown1">
   <li>
    <a class="dropdown-item" href="#">
     <i class="flag-united-kingdom flag"></i></i>English <i class="fa fa-check text-success ms-2"></i>
    </a>
   </li>
   <li>
    <hr class="dropdown-divider">
 ...
 <script src="../admin/dist/js/dishes/dishes.js"></script>
 <?php
    include './footer.php';
?>