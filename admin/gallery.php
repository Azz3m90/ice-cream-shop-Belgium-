...
<div id="content">
        ...
        <div class="cmodal-content">
            ...
            <div class="confirmation-buttons">
                ...
                <form id="deletionProccess">
                    ...
                    <button type="submit" id="confirmDeleteButton" class="btn btn-submit btn-danger"><span class="description">Delete</span></button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-image-form" enctype="multipart/form-data" method="post" data-validate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="file" id="addImageCategoryimage" name="addImageCategoryimage[]" class="form-control" accept="image/*" multiple required>
                                </div>
                        ...
                        <button type="submit" name="submit" id="submit" class="btn btn-submit btn-lg btn-block btn-success"><span class="description">Upload
                                Images</span></button>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('add-image-form').addEventListener('submit', function(event) {
            ...
            formData.append('image', document.getElementById('addImageCategoryimage').files[0]);
        ...
        axios.get('.././admin/php/gallery/get-image.php')
            .then(response => {
                ...
                galleryImages.forEach(image => {
                    ...
                    thumbnailImg.src = `${image.minified_path}`;
                    thumbnailImg.alt = '';
                    thumbnailImg.className = 'thumbnail'; // Add a class to style thumbnails if needed
                    slide.appendChild(thumbnailImg);

                    // Create nav image
                    const navImg = document.createElement('img');
                    navImg.src = `${image.minified_path}`;
                    navImg.alt = '';
                ...
                .then(response => {
                    ...
                    setTimeout(() => {
                        ...
                        if (deletedSlideElement) {
                            ...
                            const deletedNavImgElement = document.getElementById(
                                `nav${deletedImageId}`);
