     ...
     <div class="col-md-7">
      ...
      <nav class="module module-navigation left mr-4">
       <ul id="nav-main" class="nav nav-main">
        ...
        <li>
         <a href="./dishes.php">Plats</a>
        </li>
        <li class="has-dropdown ">
         <a href="#">Gestionnaire de publicités</a>
         <div class="dropdown-container">
          <ul class="dropdown-mega">
           <li>
            <a href="./emails.php">Ajouter des publicités</a>
           </li>
           <li>
            <a href="./emails-view.php">Visionneuse de publicités</a>
           </li>
          </ul>
