...
?>
 ...
 <div class="dropdown col-md-2 right mt-5">
  ...
  <ul class="dropdown-menu" aria-labelledby="Dropdown">
   ...
   <li>
    <a class="dropdown-item" href="page-contact-nl.php">
   ...
   <div class="container">
    <div class="row">
     <div class="col-lg-8 offset-lg-4">
      <h1 class="mb-0">Nous Contacter</h1>
     </div>
    </div>
   </div>
  </div>
   ...
   <div class="container">
    <div class="row align-items-center">
     <div class="col-lg-4 offset-lg-1 col-md-6 mb-5 mb-md-0">
      ...
      <span>
       <br>Adresse : Route de Philippeville 34 - 5651 Tarcienne </span>
      <span>
       <br>Cuisine : Fruits de mer </span>
      <span>
       <br>Budget : - 25 EUR </span>
      <span>
       <br>Moyen de paiement : Tous types de cartes </span>
      <hr class="hr-md">
      <div class="row">
       <div class="col-sm-6 mb-3 mb-sm-0">
        <h6 class="mb-1 text-muted">Téléphone :</h6> <a href="tel:+071218620" target="_blank">071 21 86 20</a>
       </div>
       <div class="col-sm-6">
      ...
      <hr class="hr-md">
      <h6 class="mb-3 text-muted">Suivez-nous !</h6>
