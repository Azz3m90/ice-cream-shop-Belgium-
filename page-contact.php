         ...
         <div class="container">
             <div class="row align-items-center">
                 <div class="col-lg-4 offset-lg-1 col-md-6 mb-5 mb-md-0">
                     ...
                     <span>
                         <br>Adresse : Route de Philippeville 34, Tarcienne, Belgium </span>
                     <span>
                         <br>Téléphone : +32 497 47 65 48 </span>
                     <span>
                         <br>Services : Outdoor seating, Curbside pickup </span>
                     <span>
                         <br>Prix : $ </span>
                     ...
                     <div class="row">
                         <div class="col-sm-6 mb-3 mb-sm-0">
                             <h6 class="mb-1 text-muted">Téléphone :</h6> <a href="tel:+0497476548" target="_blank">
                                 <i class="fa fa-phone fa-lg"></i> 0497 47 65 48
                             </a>
                         </div>
                         <div class="col-sm-6">
                             <h6 class="mb-1 text-muted">Email :</h6>
                             <a href="#"><a href="mailto:info@gelatonaturale.be" target="_blank">info@gelatonaturale.be</a></a>
                         </div>
                     </div>
                     <hr class="hr-md">
