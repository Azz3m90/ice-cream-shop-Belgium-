...
axios
  .get('../../../../matthias-and-sea-2023/data/menu.json')
      ...
      text +=
        ...
        <div id="${menuLinks[i]}" class="menu-category" data-category-id="${categoryIdFormatted}">
            <div class="menu-category-title">
                <div class="bg-image" style="background-image: url('${categoryImage}')">
      ...
      for (let j = 0; j < category.items.length; j++) {
        ...
        text += `<div class="col-lg-4 col-6">
                    <div class="menu-item menu-grid-item" id="${plateIdFormatted}">
                        <img class="mb-4" src="${image}" style="width: 300px;height: 200px" alt="${plateName}">
...
async function updateCategory(categoryId, newCategoryName, newImage) {
  ...
  try {
    const response = await axios.post('../../../../matthias-and-sea-2023/php/dishes/edite-category-fr.php', formData, {
      headers: {
    ...
    if (response.data.status === 'success') {
      ...
      // Handle the error
      showDangerMessage('some thing went wrong.')
    }
  } catch (error) {
    // Handle the error
...
const submitButton = document.getElementById('submit') // Replace with your submit button ID
submitButton.addEventListener('click', function (event) {
  event.preventDefault() // Prevent the default form submission
  const categoryId = document.getElementById('dish-id').value // Replace with your category ID input element
  ...
  updateCategory(categoryId, newCategoryName, newImage)
})

// Add an event listener to the submit button
const submitButtonDish = document.getElementById('Dishsubmit') // Replace with your submit button ID
submitButton.addEventListener('click', function (event) {
  event.preventDefault() // Prevent the default form submission
...
document.getElementById('edit-dish-form').addEventListener('submit', function (event) {
  ...
  axios.post('../../../../matthias-and-sea-2023/php/dishes/edit-dish-fr.php', formData)
    .then(function (response) {
...
confirmDeleteButton.addEventListener('click', function (event) {
  ...
  if (parseInt(plateId, 10) !== -1 && !isNaN(parseInt(plateId, 10))) {
    ...
    form.reset()
    axios.post('../../../../matthias-and-sea-2023/php/dishes/delete-dish-fr.php', formData)
      .then(function (response) {
        // Handle the success response
        //console.log(response.data)
    ...
    formData.append('categoryId', categoryId)
    form.reset()
    axios.post('../../../../matthias-and-sea-2023/php/dishes/delete-category-fr.php', formData)
      .then(function (response) {
        // Handle the success response
        console.log(response.data)
        showSuccessMessage() // You can customize this function based on your UI
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addCategoryForm.addEventListener('submit', function (event) {
    ...
    axios.post('../../../../matthias-and-sea-2023/php/dishes/add-category-fr.php', formData)
      .then(function (response) {
  ...
  async function getUniqueCategoryId() {
    ...
    const response = await axios.get('../../../../matthias-and-sea-2023/data/menu.json')
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addDishForm.addEventListener('submit', function (event) {
    ...
    formData.append('categoryId', categoryId)
    formData.append('categoryName', categoryName)
    formData.append('addDishCategoryName', addDishCategoryName)
    ...
    axios.post('../../../../matthias-and-sea-2023/php/dishes/add-dish-fr.php', formData)
      .then(function (response) {
        // Handle success (you may want to close the modal or update UI)
        console.log(response.data)
        populateCategoryDropdown()
