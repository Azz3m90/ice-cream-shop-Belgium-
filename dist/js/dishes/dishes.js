...
async function updateCategory(categoryId, newCategoryName, newImage) {
  ...
  try {
    const response = await axios.post('../../../../matthias-and-sea-2023/php/dishes/edite-category.php', formData, {
      headers: {
...
document.getElementById('edit-dish-form').addEventListener('submit', function (event) {
  ...
  axios.post('../../../../matthias-and-sea-2023/php/dishes/edit-dish.php', formData)
    .then(function (response) {
...
confirmDeleteButton.addEventListener('click', function (event) {
  ...
  if (parseInt(plateId, 10) !== -1 && !isNaN(parseInt(plateId, 10))) {
    ...
    form.reset()
    axios.post('../../../../matthias-and-sea-2023/php/dishes/delete-dish.php', formData)
      .then(function (response) {
        // Handle the success response
        //console.log(response.data)
    ...
    formData.append('categoryId', categoryId)
    form.reset()
    axios.post('../../../../matthias-and-sea-2023/php/dishes/delete-category.php', formData)
      .then(function (response) {
        // Handle the success response
        console.log(response.data)
        showSuccessMessage() // You can customize this function based on your UI
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addCategoryForm.addEventListener('submit', function (event) {
    ...
    axios.post('../../../../matthias-and-sea-2023/php/dishes/add-category.php', formData)
      .then(function (response) {
  ...
  async function getUniqueCategoryId() {
    ...
    const response = await axios.get('../../../../matthias-and-sea-2023/data/menu_en.json')
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addDishForm.addEventListener('submit', function (event) {
    ...
    axios.post('../../../../matthias-and-sea-2023/php/dishes/add-dish.php', formData)
      .then(function (response) {
        // Handle success (you may want to close the modal or update UI)
        console.log(response.data)
        populateCategoryDropdown()
